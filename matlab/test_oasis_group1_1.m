...
data = '../../../datasets/oasis_group1/1/';
pattern = '*.img';

dataPath = '../../experiments/oasis_group1/1/';
basisPath = '../../experiments/oasis_group1/1/basis/';
LPath = '../../experiments/oasis_group1/1/l/';
IPath = '../../experiments/oasis_group1/1/i/';
