...
data = '../../../datasets/oasis_group2/0/';
pattern = '*.img';

dataPath = '../../experiments/oasis_group2/0/';
basisPath = '../../experiments/oasis_group2/0/basis/';
LPath = '../../experiments/oasis_group2/0/l/';
IPath = '../../experiments/oasis_group2/0/i/';
